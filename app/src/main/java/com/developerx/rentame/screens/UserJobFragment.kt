...
import com.developerx.rentame.databinding.FragmentUserJobBinding
import com.developerx.rentame.models.Jobs
import com.firebase.ui.firestore.FirestoreRecyclerOptions
import com.google.firebase.firestore.Query


class UserJobFragment : Fragment(), JobClickListener {

    private var _binding: FragmentUserJobBinding ?= null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUserJobBinding.inflate(inflater, container, false)
    ...
    override fun itemClickListener(jobs: Jobs) {
        val action = UserJobFragmentDirections.actionUserJobFragmentToDetailedJobFragment2(jobs, 1)
